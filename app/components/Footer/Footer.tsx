        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    ...
                    <h3 className='text-textbl text-xs font-medium mt-5 mb-4 lg:mb-16'> Obtain accurate HIN and history reports for marine vehicles  with <br /> Certified Marine Check. Trusted expertise and 24/7 assistance.</h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>@2023 - Chef&apos;s kitchen. All rights reserved.</h4>
                <div className="flex gap-5 mt-5 md:mt-0 justify-center md:justify-start">
                    <h4 className='text-darkgrey text-sm font-normal'><Link href="/privacy-policy">Privacy policy</Link></h4>
                    <div className="h-5 bg-bordertop w-0.5"></div>
                    <h4 className='text-darkgrey text-sm font-normal'><Link href="/terms-conditions">Terms & conditions</Link></h4>
                </div>
            </div>
        </div>
    )
